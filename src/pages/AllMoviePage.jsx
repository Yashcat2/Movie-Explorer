// src/pages/AllMoviePage.jsx
import React, { useEffect, useState } from 'react';
import { fetchAllMovies, getImageUrl } from '../api/tmdb';
import {
...
const AllMoviePage = () => {
  ...
  useEffect(() => {
    const loadMovies = async () => {
      try {
        const data = await fetchAllMovies(); // returns { results: [...] }
        setMovies(data.results); // so movies is an array
      } catch (error) {
